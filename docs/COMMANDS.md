...
`--growing` 是後續增量擴散。它會讀 repo signals、Gitea/local issues、Redmine imports、PR refs、latest run、reports、existing cases/runners/rules，產生新的 product-runtime command contracts。
