...
prompts. It has two halves. When this reference is used through AI Quality Pilot, SQLite is the
canonical local representation and JSON is the portable export; Neo4j or any remote graph
service is optional future adapter work, never a setup prerequisite or QA green gate.
